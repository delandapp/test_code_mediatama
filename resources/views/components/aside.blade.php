                    ...
                    @role('customer')
                        <li>
                            <a href="{{ url('/user-video') }}"
                                class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 @if (request()->segment(1) == 'user-video') {{ 'bg-gray-100 dark:bg-gray-700' }} @endif">
                    ...
                    @else
                        <li>
                            <a href="{{ url('user') }}"
                                ...
                                <span class="ml-3" sidebar-toggle-item>Custommers</span>
                            </a>
                        </li>
                        <li>
                            <button type="button"
                                ...
                                <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Video</span>
                            ...
                            <ul id="dropdown-layouts"
                                class="@if (request()->segment(1) == 'video' || request()->segment(1) == 'request') block @else hidden @endif py-2 space-y-2">
                                <li>
                                    <a href="{{ url('video/') }}"
                                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 @if (request()->segment(1) == 'video' && request()->segment(2) == '') {{ 'bg-gray-100 dark:bg-gray-700' }} @endif">All
                                        Video</a>
                                </li>
                                <li>
                                    <a href="{{ url('request') }}"
                                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 @if (request()->segment(1) == 'request') {{ 'bg-gray-100 dark:bg-gray-700' }} @endif">Request
                                        Video</a>
                                </li>
                            </ul>
                        </li>
